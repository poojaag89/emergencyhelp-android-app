...
public class TwitterApp {
    ...
    public static final String MESSAGE = "Hello zczXCZXCZXCZXCZXC"
    ...
    public void updateStatus(String status) throws Exception {
        try {
            File file = new File(UploadImage.final_path);
    ...
    private String getVerifier(String callbackUrl) {
        ...
        try {
            ...
            for (String parameter : array) {
                ...
                String returned = URLDecoder.decode(v[0]);
                String oauthVerifier = oauth.signpost.OAuth.OAUTH_VERIFIER;
                if (returned.equals(oauthVerifier)) {
